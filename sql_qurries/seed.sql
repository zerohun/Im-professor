...
INSERT INTO professor_infos(professor_id, major_id,name, photo, content) values(1, 1,"권동섭", "photo.jpg", "정말 정말 좋은 교수님");
INSERT INTO users(major_id, name, email) values(1, "오세도", "sedo@sedo.com");
